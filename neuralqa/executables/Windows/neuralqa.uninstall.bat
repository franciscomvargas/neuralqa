...
set model_execs_basepath=%model_path_basepath%\neuralqa\executables\Windows
set req_uninstall_path=%model_execs_basepath%\neuralqa.uninstall.bat


:: - Miniconda (virtual environment) Vars
set conda_basepath=Desota\Portables\miniconda3\condabin\conda.bat
set model_env_basepath=%model_path_basepath%\neuralqa\env

:: - NSSM VARS
set service_name=neuralqa_service
set model_stop_basepath=%model_execs_basepath%\neuralqa.stop.bat
